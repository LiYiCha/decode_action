//Mon Jan 20 2025 03:54:48 GMT+0000 (Coordinated Universal Time)
//Base:https://github.com/echo094/decode-js
//Modify:https://github.com/smallfawn/decode_action
const _0x227d03 = new _0x3bc472("酷狗音乐");
let _0x4575f7 = ["\n"];
let _0x85d25e = "kgyyCookie";
let _0x27221c = (_0x227d03.isNode() ? process.env[_0x85d25e] : _0x227d03.getdata(_0x85d25e)) || "";
let _0x3a23fa = (_0x227d03.isNode() ? process.env.kgWithdrawTime : _0x227d03.getdata("kgWithdrawTime")) || 9;
let _0x6eec9f = [];
let _0x2a8f75 = 0;
let _0xb16581 = 0;
let _0x3f5c83 = new Date().getHours();
let _0x9726d2 = "application/json;charset=utf-8";
let _0x3340b4 = "Mozilla/5.0 (Linux; Android 9; MI 8 Build/PQ3A.190801.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/89.0.4389.72 KugouBrowser/6.2 TBS/046010 Mobile Safari/537.36 GDTTangramMobSDK/8.455.2731 GDTMobSDK/8.455.2731";
let _0x9511bb = "https://h5.kugou.com/";
let _0x17c13e = "https://h5.kugou.com";
let _0x5bb8e9 = 1005;
let _0x1ad373 = 11209;
let _0x5297c3 = "client";
let _0x5c42de = "OIlwieks28dk2k092lksi2UIkp";
let _0x1e9fb6 = 300;
let _0x5e8d97 = 1500;
let _0x1f6439 = "0123456789";
let _0x36412a = "qwertyuiopasdfghjklzxcvbnm";
let _0x5b8f13 = "QWERTYUIOPASDFGHJKLZXCVBNM";
let _0x168977 = 8;
let _0x257f42 = 300;
let _0x3fe904 = 1000;
let _0x308bdc = 1.01;
let _0x389e40 = "kugou";
let _0x188dcc = "https://leafxcy.coding.net/api/user/leafxcy/project/validcode/shared-depot/validCode/git/blob/master/code.json";
let _0x42e2c1 = "https://leafxcy.coding.net/api/user/leafxcy/project/validcode/shared-depot/validCode/git/blob/master/" + _0x389e40 + ".json";
class _0x502821 {
  ...
  genSign(_0x142eb2, _0xb32db2) {
    ...
    let _0x53613f = _0x3de3a1("" + _0x5c42de + _0x535d35 + _0xb32db2 + _0x5c42de);
    return _0x53613f;
  }
  async taskApi(_0x187022 = {}) {
    ...
    try {
      ...
      let _0xe7aa27 = this.getDefaultQueryParam();
    ...
    try {
      ...
      if (_0x3472c0.errcode == 0) {
        ...
        for (let _0x301cbf of _0x3472c0.data.tasks) {
          ...
          let _0x46f482 = _0x301cbf.profile.name + "[id=" + _0x301cbf.profile.taskid + "] " + _0x301cbf.state.done_count + "/" + _0x301cbf.state.max_done_count + "，" + (_0x301cbf.state.state == 0 ? "未" : "已") + "完成";
          if (_0x16186a) {
  ...
  async submitTask(_0x423a95, _0x54ae84, _0x1836cc = "") {
    ...
    try {
      ...
      let _0x5ef058 = _0x423a95.profile.name;
      if (_0x54ae84) {
        _0x5ef058 += "翻倍视频";
      }
  ...
  async getTaskInfo(_0x10b183) {
    ...
    try {
      ...
      if (_0x489eaf.errcode == 0) {
        ...
        let _0x12a390 = _0x489eaf.data.state.state == 0;
        let _0x3846b5 = _0x489eaf.data.profile.name + "[id=" + _0x489eaf.data.profile.taskid + "] " + _0x489eaf.data.state.done_count + "/" + _0x489eaf.data.state.max_done_count + "，" + (_0x489eaf.data.state.state == 0 ? "未" : "已") + "完成";
        if (_0x12a390) {
...
async function _0x54301c() {
  if ($request.url.includes("v1/app/userAppInfo")) {
    try {
      ...
      let _0x438157 = $request.headers.Authorization.match(/Bearer (\w+)/)[1];
      let _0x1c201a = _0x444afe + "#" + _0x438157;
      let _0x4b1ad3 = _0x4575f7[0];
...
async function _0x518aac(_0x1c2ad3 = 0) {
  ...
  try {
    ...
    let _0x26ebfd = null;
    let _0xedbf3b = await _0x372aac("get", _0x399009);
    if (_0xedbf3b.err) {
    ...
    if (!_0x26ebfd) {
      if (_0x1c2ad3 < _0x168977) {
        let _0x279c0a = Math.floor(Math.random() * _0x3fe904) + _0x257f42;
  ...
  return new class {
    ...
    getdata(_0xb016cd) {
      ...
      if (/^@/.test(_0xb016cd)) {
        ...
        const _0xe26d5e = _0x1761b4 ? this.getval(_0x1761b4) : "";
        if (_0xe26d5e) {
          try {
    ...
    setdata(_0x4ac057, _0x21021c) {
      ...
      if (/^@/.test(_0x21021c)) {
        ...
        const _0x3d1976 = this.getval(_0x3d5970);
        const _0x162805 = _0x3d5970 ? "null" === _0x3d1976 ? null : _0x3d1976 || "{}" : "{}";
        try {
    ...
    setval(_0x28ab63, _0x195c19) {
      return this.isSurge() || this.isLoon() ? $persistentStore.write(_0x28ab63, _0x195c19) : this.isQuanX() ? $prefs.setValueForKey(_0x28ab63, _0x195c19) : this.isNode() ? (this.data = this.loaddata(), this.data[_0x195c19] = _0x28ab63, this.writedata(), true) : this.data && this.data[_0x195c19] || null;
    }
      ...
      const _0x41c2a4 = _0x3ed45b => {
        ...
        if ("object" == typeof _0x3ed45b) {
          if (this.isLoon()) {
            ...
            let _0x9a5a9 = _0x3ed45b.mediaUrl || _0x3ed45b["media-url"];
            const _0x4e1f30 = {
              openUrl: _0x51b3f8,
              mediaUrl: _0x9a5a9
            };
          ...
          if (this.isQuanX()) {
            ...
            let _0x117b71 = _0x3ed45b["media-url"] || _0x3ed45b.mediaUrl;
            const _0x491046 = {
              "open-url": _0x331b9d,
              "media-url": _0x117b71
            };
    ...
    padStr(_0x2ecb38, _0x34e06a, _0x461a8e = "0") {
      ...
      let _0xea4cc9 = _0x34e06a > _0x2eb5c8.length ? _0x34e06a - _0x2eb5c8.length : 0;
      let _0x360c88 = "";
    ...
    str2json(_0x3f654f, _0x4bcab5 = false) {
      ...
      for (let _0x3b6004 of _0x3f654f.split("&")) {
        ...
        let _0x55c316 = _0x3b6004.substr(_0x442aa2 + 1);
        if (_0x4bcab5) {
    ...
    async done(_0x51d1d5 = {}) {
      ...
      const _0x3b7873 = (_0x127915 - this.startTime) / 1000;
