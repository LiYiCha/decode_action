//Thu Nov 14 2024 02:05:10 GMT+0000 (Coordinated Universal Time)
  ...
  for (let _0x36daa2 = 0; _0x36daa2 < _0x5e4d5f.length; _0x36daa2++) {
    {
      ...
      const _0xafbab7 = _0x5e4d5f[_0x36daa2].split("#")[1];
      ...
      if (_0x1b177c.data.status) {
        ...
        if (_0x1b177c.data.data.signStatus != 1) {
          ...
          const _0x347dcb = await sendPostRequest("https://webapi2.qmai.cn/web/cmk-center/sign/takePartInSign", _0x10d344, {
            activityId: "947079313798000641",
            appid: appid,
            storeId: 49006,
            timestamp: _0x1aac39,
...
function sgin(_0x3476a5, _0x4ddd3e) {
  ...
  var _0x2b7dd8 = 49006;
  var _0x353e1c = _0x2b7dd8 ? _0x2b7dd8.toString() : undefined;
  var _0x51bf46 = {
  ...
  var _0x3b1a6d = Object.keys(_0x51bf46).sort();
  var _0x13e143 = _0x3b1a6d.reduce(function (_0x103a9d, _0x3759b6) {
    _0x103a9d[_0x3759b6] = _0x51bf46[_0x3759b6];
    return _0x103a9d;
  }, {});
  var _0x68bc1a = Object.entries(_0x13e143).map(function (_0x4f33ee) {
    var [_0x404623, _0x400f86] = _0x4f33ee;
    return _0x404623 + "=" + _0x400f86;
  }).join("&") + "&key=" + _0x376619.split("").reverse().join("");
  var _0x17e02e = CryptoJS.MD5(_0x68bc1a).toString(CryptoJS.enc.Hex).toUpperCase();
  return _0x17e02e;
}
function Env(_0x2158dc, _0x319f5c) {
  ...
  return new class {
      ...
      {
        {
          ...
          const _0x452396 = this.path.resolve(process.cwd(), this.dataFile);
          const _0x5b3291 = this.fs.existsSync(_0x27794a);
          const _0x1f4621 = !_0x5b3291 && this.fs.existsSync(_0x452396);
        ...
        if (this.isNode()) {
          {
            ...
            const _0x3e68cf = this.path.resolve(process.cwd(), this.dataFile);
            const _0x2c1e3d = this.fs.existsSync(_0x300f30);
            const _0x157c41 = !_0x2c1e3d && this.fs.existsSync(_0x3e68cf);
            const _0x3fbce0 = JSON.stringify(this.data);
    ...
    lodash_get(_0x250ae5, _0xcac6a7, _0x4394e7) {
      ...
      for (const _0x42f3c4 of _0x427ac8) if (_0xbd4cf1 = Object(_0xbd4cf1)[_0x42f3c4], undefined === _0xbd4cf1) {
        return _0x4394e7;
      }
      return _0xbd4cf1;
    }
      ...
      if (/^@/.test(_0x35dcad)) {
        {
          ...
          const _0x4642af = _0x92b75e ? this.getval(_0x92b75e) : "";
          if (_0x4642af) {
            try {
        ...
        if (/^@/.test(_0x33757b)) {
          {
            ...
            const _0x2b6f7a = this.getval(_0x31bb11);
            const _0x34a837 = _0x31bb11 ? "null" === _0x2b6f7a ? null : _0x2b6f7a || "{}" : "{}";
            try {
              {
    ...
    setval(_0x33fd13, _0x43ce49) {
      return this.isSurge() || this.isLoon() ? $persistentStore.write(_0x33fd13, _0x43ce49) : this.isQuanX() ? $prefs.setValueForKey(_0x33fd13, _0x43ce49) : this.isNode() ? (this.data = this.loaddata(), this.data[_0x43ce49] = _0x33fd13, this.writedata(), true) : this.data && this.data[_0x43ce49] || null;
    }
    initGotEnv(_0x9a680a) {
      this.got = this.got ? this.got : require("got");
      this.cktough = this.cktough ? this.cktough : require("tough-cookie");
      this.ckjar = this.ckjar ? this.ckjar : new this.cktough.CookieJar();
      _0x9a680a && (_0x9a680a.headers = _0x9a680a.headers ? _0x9a680a.headers : {}, undefined === _0x9a680a.headers.Cookie && undefined === _0x9a680a.cookieJar && (_0x9a680a.cookieJar = this.ckjar));
    }
      ...
      const _0x47621e = _0x285971 => {
        ...
        if ("object" == typeof _0x285971) {
          if (this.isLoon()) {
            ...
            let _0x3c2c3e = _0x285971.mediaUrl || _0x285971["media-url"];
            return {
              openUrl: _0x2fc5da,
              mediaUrl: _0x3c2c3e
            };
          ...
          if (this.isQuanX()) {
            {
              ...
              let _0x2c38bd = _0x285971["media-url"] || _0x285971.mediaUrl;
              return {
                "open-url": _0xaf25a0,
                "media-url": _0x2c38bd
              };
    ...
    wait(_0xf702c) {
      ...
      const _0x2dead8 = (_0x533473 - this.startTime) / 1000;
  ...
  try {
    {
      ...
      const _0x473c45 = JSON.parse(_0x1eaca6.getBody("utf8"));
